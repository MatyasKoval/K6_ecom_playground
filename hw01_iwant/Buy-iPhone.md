...
**NFR**
- Test1:
	- Prostředí https://www.iwant.cz/ - https://ecommerce-playground.lambdatest.io/
	- Každý request musí být odbaven do 1000ms. - check
	- Našeptávač musí vrátit více jako 10 iphonů. - tolik jich tam není beru 3
	- Číselník vrátí více jak 1000 filtrů. - dunno
	- Výsledky vyhledávání zobrazí na stránce 12 iphonů. - tolik jich tam není, beru 4
	- Funguje stránkování a vrací tlačítka pro přechod na další stránku.
	- Stránka s detailem iPhone se zobrazí do 1500ms - check
	- Vyhledání iPhone nesmí trvat déle jak 1300ms - check
